...
final class ResetDemoAccountCommand extends Command
{
    ...
    private function taskFixtures(): array
    {
        return [
            ...
            'Chase Shopify security review' => ['company' => 'Shopify', 'contact' => 'Rachel Osei', 'opportunity' => 'Shopify Merchant Analytics', 'status' => 'To do', 'priority' => 'High', 'due_in_days' => -1, 'assigned' => true, 'description' => 'Security workspace still owes us the completed questionnaire before procurement starts.'],
            ...
            'Introduce Airtable to the data workspace' => ['company' => 'Airtable', 'contact' => 'Gabriel Ruiz', 'opportunity' => '', 'status' => 'To do', 'priority' => 'Low', 'due_in_days' => 15, 'assigned' => false, 'description' => 'Warm introduction between their data platform manager and our engineers.'],
    ...
    private function noteFixtures(): array
    {
        return [
            ...
            'Amplitude analytics goals' => ['company' => 'Amplitude', 'contact' => 'Helena Roth', 'opportunity' => 'Amplitude Product Insights', 'body' => 'They want activation and retention dashboards in the first month. Product analytics workspace of six, expanding next quarter.'],
        ];
    }
