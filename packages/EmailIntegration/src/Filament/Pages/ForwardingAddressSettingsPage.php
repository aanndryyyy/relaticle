    ...
    public function addBlocklistAction(): Action
    {
        return Action::make('addBlocklist')
            ...
            ->action(function (array $data, UpdateUserForwardingBlocklistAction $updateBlocklist): void {
                ...
                $updateBlocklist->execute($this->authUser(), $this->workspace(), $this->blocklistRowsFromValues($emails, $domains));
    ...
    public function saveAction(): Action
    {
        return Action::make('save')
            ...
            ->action(function (
                ...
                $updateSettings->execute($this->authUser(), $this->workspace(), $tier);
